...
public class PutCloverCommand extends CompositeCommandBase {
	...
	public void execute() {
		...
		*/
		...
		if ((helperPrecondition1CurrentTileResult0ContentsSize() == 1
				&& helperPrecondition1CurrentTileResult0ContentsAt0() == self) == false) {
		...
		*/
		...
		if ((helperPostcondition2CurrentTileResult0ContentsSize() == 2 && self.cloverAvailable()) == false) {
			throw new CommandConstraintException(
	...
	private TileContent helperPrecondition1CurrentTileResult0ContentsAt0() {
	...
	private int helperPrecondition1CurrentTileResult0ContentsSize() {
		Tile result0 = self.getCurrentTile();
		if (result0 == null) {
			return 0;
		}
